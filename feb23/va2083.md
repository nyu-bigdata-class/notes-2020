...
####  Illustration
* Let the demand by 3 users be (2, 4, 8) respectively and the maximum resource capacity 12.
* As per max-min fairness, we first divide 12 (total capacity) equally to all the 3 users. We end up dividing 4 units for each user.
* Now we see that user 1 got 2 extra resources, which is more than what they asked for. User 2 and 3 still have unfulfilled requirements.
* We distribute the extra resources given to users 1, to user 2, and 3 and hence give 1 unit each to users 2 and 3.
* Now user 2 has 4 (requirements fulfilled) and user 3 also has 4 (requirements unfulfilled) units of resources.
