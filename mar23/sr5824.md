...
1. High Speed datacenters
  1. Lossless fabrics for having no loss.
	...
	phenomenon that occurs when a line of packets is held up by the first
     ...
     3. Complex swithc configuration
...
3. Drawbacks of specilization
   1. Breaks abstraction boundaries b/w component and increases
      s/w complexity.
...
1. Analysis of Incremental Server deployment for scalable NFV networks
2. Chaining of Virtual Network functions
